...
const getMachineRequests = async(req,resp)=>{
  ...
  try{
    ...
    {
      return resp.status(401).json({status:'false',message:'No requests till yet'});
    }
    else{
      return resp.status(200).json({status:'true',message:"Data Fetched Successfully",machineRequests});
    }
