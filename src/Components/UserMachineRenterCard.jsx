  ...
  return (
    <>
      ...
      <div className="flex z-70 ">
        ...
        {/* Sidebar */}
        <div
          className={`fixed inset-y-0 right-0 w-[20vw] shadow-2xl bg-white transform ${isOpen ? "translate-x-0" : "translate-x-full"
        ...
        >
          ...
          <div className="py-20 px-8">
            {payloading ? (
              ...
              <>
                <button
                  className="text-2xl font-semibold flex items-center absolute left-6 text-black"
                  onClick={toggleSidebar}
                >
                  X
                </button>

                <h1 className=" w-full text-center text-2xl text-green-500 font-bold  ">
                  Pay With Secure
                </h1>
                <div className="px-3 py-2 mt-12">
                  <h1 className=" w-full mt-3 text-lg border border-gray-400  rounded-lg p-2 text-center text-gray-500  ">
                    {props.item.title}
                  </h1>
                  ...
                  <h1 className=" w-full mt-3 text-lg border border-gray-400  rounded-lg p-2 text-center text-gray-500 ">
                    Rent Tenure : {activerentdata.tenure}
                  </h1>

                  <h1 className=" w-full mt-3 text-lg border border-gray-400  rounded-lg p-2 text-center text-gray-500">
                    Rent Amount per Year RS.{activerentdata.bidamount}
                  </h1>

                  <h1 className=" w-full mt-3 text-lg border border-gray-400  rounded-lg p-2 text-center text-gray-500">
                    Total Amount{" "}
                    <h1 className="mt-4 text-4xl">
                      RS.{activerentdata.bidamount * tenure}
                    </h1>
                  </h1>
                </div>
                ...
                <div className="w-full flex justify-center ">
                  <button
                    className="w-28 py-2 px-4 rounded-lg text-white  hover:cursor-pointer hover:bg-green-500 shadow-xl bg-green-600 flex justify-center items-center mt-10"
